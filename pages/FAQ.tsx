    ...
    <div className="pb-20">
       <div className="bg-slate-100 py-16">
        <Reveal className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl font-bold mb-4 text-slate-900">Frequently Asked Questions</h1>
          <p className="text-slate-600 mb-8">Find answers to common questions about Gifted Dreamers, donations, matching gifts, and volunteering.</p>
          ...
          <div className="relative max-w-xl mx-auto">
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
            />
